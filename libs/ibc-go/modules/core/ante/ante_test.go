...
import (
	...
	appante "github.com/gridironx/gridchain/app/ante"
...
func (suite *AnteTestSuite) TestAnteDecorator() {
	testCases := []struct {
		...
		},
		{
			...
			func(suite *AnteTestSuite) []ibcmsg.Msg {
				msgs := []ibcmsg.Msg{&clienttypes.MsgUpdateClient{Signer: "did:fury:gridex1mnd48anr8jwjjzt347tpdzwfddem08r4d66j3z"}, &clienttypes.MsgUpdateClient{Signer: "did:fury:gridex1mnd48anr8jwjjzt347tpdzwfddem08r4d66j3z"}, &clienttypes.MsgUpdateClient{Signer: "did:fury:gridex1mnd48anr8jwjjzt347tpdzwfddem08r4d66j3z"}}
