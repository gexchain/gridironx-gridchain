...
func (suite *AnteTestSuite) TestAnteDecorator() {
	testCases := []struct {
		...
		},
		{
			...
			func(suite *AnteTestSuite) []ibcmsg.Msg {
				msgs := []ibcmsg.Msg{&clienttypes.MsgUpdateClient{Signer: "fury1mnd48anr8jwjjzt347tpdzwfddem08r4d66j3z"}, &clienttypes.MsgUpdateClient{Signer: "fury1mnd48anr8jwjjzt347tpdzwfddem08r4d66j3z"}, &clienttypes.MsgUpdateClient{Signer: "fury1mnd48anr8jwjjzt347tpdzwfddem08r4d66j3z"}}
