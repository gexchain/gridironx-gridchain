...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/gridironx/gridchain/libs/cosmos-sdk/types/errors.Wrap",
		"github.com/gridironx/gridchain/libs/cosmos-sdk/types/errors.Wrapf",
		"github.com/gridironx/gridchain/libs/cosmos-sdk/types/errors.WithType",
