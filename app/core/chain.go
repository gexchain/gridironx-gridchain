...
// transactions. There should only be a single implementation in GRIDIronxChain. For
// the purposes of GRIDIronxChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: GRIDIronxChain will distribute the fees out to validators, so the structure
