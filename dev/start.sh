...
#    gridchaind start --pruning=nothing --rpc.unsafe \
    nohup gridchaind start --rpc.unsafe \
...
gridchaincli keys add --recover admin16 -m "palace cube bitter light woman side pave cereal donor bronze twice work" -y
...
# gridchaincli tx send captain 0x83D83497431C2D3FEab296a9fba4e5FaDD2f7eD0 1fury --fees 1fury -b block -y
