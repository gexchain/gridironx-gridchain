...
contract Exchange is ERC20 {
    ...
    string public wasmContractAddress = "furyex14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s6fqu27";
    ...
    function send_to_wasm(string memory recipient,string memory wasmContract , uint256 amount) public {
        ...
        emit __GRIDCSendToWasm(wasmContract,recipient, amount);
    }
}
