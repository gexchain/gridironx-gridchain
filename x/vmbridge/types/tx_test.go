...
func TestMsgSendToEvm_GetSignBytes(t *testing.T) {
	testCases := []struct {
		...
		{
			name:  "sender is error",
			msg:   MsgSendToEvm{Sender: "did:fury:gridex111", Contract: sdk.AccAddress{0x2}.String(), Recipient: sdk.AccAddress{0x3}.String(), Amount: sdk.NewInt(1)},
			isErr: true,
		},
		{
			name:  "contract is error",
			msg:   MsgSendToEvm{Sender: sdk.AccAddress{0x1}.String(), Contract: "did:fury:gridex111", Recipient: sdk.AccAddress{0x3}.String(), Amount: sdk.NewInt(1)},
			isErr: true,
		},
		{
			name:  "recipient is error",
			msg:   MsgSendToEvm{Sender: sdk.AccAddress{0x1}.String(), Contract: sdk.AccAddress{0x2}.String(), Recipient: "did:fury:gridex111", Amount: sdk.NewInt(1)},
			isErr: true,
		},
		{
...
func TestMsgCallToEvm_GetSignBytes(t *testing.T) {
	testCases := []struct {
		...
		{
			name:  "sender is error",
			msg:   MsgCallToEvm{Sender: "did:fury:gridex111", Evmaddr: sdk.AccAddress{0x2}.String(), Value: sdk.NewInt(1), Calldata: "CALL DATA"},
			isErr: true,
		},
		{
			name:  "contract is error",
			msg:   MsgCallToEvm{Sender: sdk.AccAddress{0x1}.String(), Evmaddr: "did:fury:gridex111", Value: sdk.NewInt(1), Calldata: "CALL DATA"},
			isErr: true,
		},
		{
