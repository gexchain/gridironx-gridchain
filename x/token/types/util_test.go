...
func TestStrToTransfers(t *testing.T) {
	...
	coinStr := `[{"to":"did:fury:gridex1jedas2n0pq2c68pelztgel8ht8pz50rh7s7vfz","amount":"1` + common.NativeToken + `"}]`
	...
	coinStr = `[{"to":"did:fury:gridex1jedas2n0pq2c68pelztgel8ht8pz50rh7s7vfz",amount":"1"}]`
