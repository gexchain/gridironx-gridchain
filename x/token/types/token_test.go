...
func TestToken(t *testing.T) {
	...
	common.InitConfig()
	addr, err := sdk.AccAddressFromBech32("furyex1jedas2n0pq2c68pelztgel8ht8pz50rh7s7vfz")
	require.Nil(t, err)
	...
	testCase := []struct {
		...
		{Token{
			...
			Owner:               addr,
			Mintable:            true,
		}, `{"description":"okblockchain coin","symbol":"` + common.NativeToken + `","original_symbol":"` + common.NativeToken + `","whole_name":"ok coin","original_total_supply":"1000000000.000000000000000000","type":0,"owner":"furyex1jedas2n0pq2c68pelztgel8ht8pz50rh7s7vfz","mintable":true}`},
	}
