...
const (
 ...
 IsAdded:				true
 DistributorAddrs:
						did:fury:gridex1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
						did:fury:gridex1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpxuz0nc`
 ...
 IsAdded:				true
 ContractList:
						Address: did:fury:gridex1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
Method List:
Sign: 0x11111111Extra: TEST1
Sign: 0x22222222Extra: TEST2
						Address: did:fury:gridex1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpxuz0nc
Method List:
...
func (suite *ProposalTestSuite) TestProposal_ManageSysContractAddressProposal() {
 ...
 ContractAddr:          did:fury:gridex1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
 IsAdded:				true`
