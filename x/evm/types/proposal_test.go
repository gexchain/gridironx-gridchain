...
const (
 ...
 IsAdded:				true
 DistributorAddrs:
						fury1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
						fury1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpxuz0nc`
 ...
 IsAdded:				true
 ContractList:
						Address: fury1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
Method List:
Sign: 0x11111111Extra: TEST1
Sign: 0x22222222Extra: TEST2
						Address: fury1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpxuz0nc
Method List:
...
func (suite *ProposalTestSuite) TestProposal_ManageSysContractAddressProposal() {
 ...
 ContractAddr:          fury1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2
 IsAdded:				true`
