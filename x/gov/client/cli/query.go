...
Example:
$ %s query gov proposals --depositor furyex1rf9wr069pt64e58f2w3mjs9w72g8vemzw26658
$ %s query gov proposals --voter furyex1rf9wr069pt64e58f2w3mjs9w72g8vemzw26658
...
Example:
$ %s query gov vote 1 furyex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query gov deposit 1 furyex1rf9wr069pt64e58f2w3mjs9w72g8vemzw26658
`,
				version.ClientName,
			),
		),
