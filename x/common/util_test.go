...
func TestHasSufCoins(t *testing.T) {
	initConfig()
	addr, err := sdk.AccAddressFromBech32("furyex1rf9wr069pt64e58f2w3mjs9w72g8vemzw26658")
	require.Nil(t, err)
...
func TestBlackHoleAddress(t *testing.T) {
	...
	a := addr.String()
	fmt.Println(a)
	require.Equal(t, "furyex1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqm2k6w2", addr.String())
}
