	...
	return &cobra.Command{
		...
		Long: strings.TrimSpace(
			fmt.Sprintf("Add shares to one or more validators by all deposited %s.\n\nExample:\n$ %s tx staking add-shares "+
				"furyvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg,"+
				"furyvaloper1svzxp4ts5le2s4zugx34ajt6shz2hg42dnwst5,"+
				"furyvaloper10q0rk5qnyag7wfvvt7rtphlw589m7frshchly8,"+
				"furyvaloper1g7znsf24w4jc3xfca88pq9kmlyjdare6tr3mk6 --from mykey\n",
...
Example:
$ %s tx staking proxy bind fury1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02 --from mykey
`,
				version.ClientName),
		),
		RunE: func(cmd *cobra.Command, args []string) error {
