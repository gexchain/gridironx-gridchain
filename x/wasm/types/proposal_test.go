...
`,
		...
		"update deployment whitelist": {
			src: &UpdateDeploymentWhitelistProposal{
				Title:            "Foo",
				Description:      "Bar",
				DistributorAddrs: []string{"furyex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02", "furyex10q0rk5qnyag7wfvvt7rtphlw589m7frs3hvqmf"},
			},
			exp: `title:"Foo" description:"Bar" distributorAddrs:"furyex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02" distributorAddrs:"furyex10q0rk5qnyag7wfvvt7rtphlw589m7frs3hvqmf" `,
		},
	}
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
...
- furyex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02
- furyex10q0rk5qnyag7wfvvt7rtphlw589m7frs3hvqmf
`,
		},
	}
	for msg, spec := range specs {
			...
			src: `
{
	"title": "foo",
	"description": "bar",
	"distributorAddrs": ["furyex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02", "furyex10q0rk5qnyag7wfvvt7rtphlw589m7frs3hvqmf"]
}`,
			...
			exp: `
{
	...
	"value":{"content":{"type":"wasm/MigrateContractProposal","value":{"msg":{"foo":"bar"}}},"initial_deposit":[],"proposer":""}
		...
		"update wasm deployment whitelist": {
			src: &UpdateDeploymentWhitelistProposal{DistributorAddrs: []string{"furyex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02", "furyex10q0rk5qnyag7wfvvt7rtphlw589m7frs3hvqmf"}},
			exp: `
{	
	"type":"gridchain/gov/MsgSubmitProposal",
	"value":{"content":{"type":"wasm/UpdateDeploymentWhitelistProposal","value":{"distributorAddrs":["furyex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02","furyex10q0rk5qnyag7wfvvt7rtphlw589m7frs3hvqmf"]}},"initial_deposit":[],"proposer":""}
}`,
		},
	}
	for name, spec := range specs {
