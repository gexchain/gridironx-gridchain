	...
	genesisTemplate := `
{
  ...
  "codes": [
    {
      ...
      "code_info": {
        "code_hash": %q,
        "creator": "did:fury:gridex190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0",
        "instantiate_config": {
          "permission": "OnlyAddress",
          "address": "did:fury:gridex190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"
        }
      },
      "code_bytes": %q
    }
  ...
  "contracts": [
    {
      ...
      "contract_info": {
        "code_id": "1",
        "creator": "did:fury:gridex1fsfwwvl93qv6r56jpu084hxxzn9zphnyxhske5",
        "admin": "did:fury:gridex1s0vrf96rrsknl64jj65lhf89ltwj7lksr7m3r9",
        "label": "ȀĴnZV芢毤"
      }
    }
  ],
  ...
  {"id_key": "BGxhc3RDb250cmFjdElk", "value": "3"}
	...
	codeCreatorAddr := "did:fury:gridex190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"
	...
	contractCreatorAddr := "did:fury:gridex1fsfwwvl93qv6r56jpu084hxxzn9zphnyxhske5"
	adminAddr := "did:fury:gridex1s0vrf96rrsknl64jj65lhf89ltwj7lksr7m3r9"
