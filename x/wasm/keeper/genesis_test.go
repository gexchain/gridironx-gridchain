	...
	genesisTemplate := `
{
  ...
  "codes": [
    {
      ...
      "code_info": {
        "code_hash": %q,
        "creator": "fury190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0",
        "instantiate_config": {
          "permission": "OnlyAddress",
          "address": "fury190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"
        }
      },
      "code_bytes": %q
    }
  ...
  "contracts": [
    {
      ...
      "contract_info": {
        "code_id": "1",
        "creator": "fury1fsfwwvl93qv6r56jpu084hxxzn9zphnyxhske5",
        "admin": "fury1s0vrf96rrsknl64jj65lhf89ltwj7lksr7m3r9",
        "label": "ȀĴnZV芢毤"
      }
    }
  ],
  ...
  {"id_key": "BGxhc3RDb250cmFjdElk", "value": "3"}
	...
	codeCreatorAddr := "fury190227rqaps5nplhg2tg8hww7slvvquzy0qa0l0"
	...
	contractCreatorAddr := "fury1fsfwwvl93qv6r56jpu084hxxzn9zphnyxhske5"
	adminAddr := "fury1s0vrf96rrsknl64jj65lhf89ltwj7lksr7m3r9"
