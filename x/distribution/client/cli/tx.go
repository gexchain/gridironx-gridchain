...
Example:
$ %s tx distr set-withdraw-addr did:fury:gridex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02 --from mykey
`,
				version.ClientName,
			),
		),
...
Example:
$ %s tx distr withdraw-rewards did:fury:gridexvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey 
$ %s tx distr withdraw-rewards did:fury:gridexvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey --commission
...
Example:
$ %s tx distr withdraw-rewards did:fury:gridexvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey(validator)			# withdraw mykey's commission only
$ %s tx distr withdraw-rewards did:fury:gridexvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey(validator&delegator)	# withdraw mykey's reward only
`,
...

{
  ...
  "recipient": "did:fury:gridex1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02",
  "amount": [
    {
      "denom": "%s",
      "amount": "10000"
